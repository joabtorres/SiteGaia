	...
	<div class="container-categoria">
		<div class="row">
			...
			<div class="row">
				<div class="col-sm-12 col-md-12">
					<p class="text-center"><img src="_imagens/supermecado.jpg" class="img-radius" alt="Supermercados"></p>
					<p class="text-justify"> O <strong>Supermercado</strong> é o local onde as pessoas compram gêneros alimentícios e artigos de higiene, limpeza e beleza, frios, carnes, pães, hortifrúti e congelados.
					</p>
		...
		<footer>
			...
			<div class="col-md-4 col-md-offset-3 col-lg-4  col-sm-5">
				Desenvolvidor por <strong><a target="_blank" href="http:\\www.endogenese.com.br">Endogenêse Soluções</a></strong>
			</div>
			</div>
		</footer>
	</section>
