	...
	<section class="container-fluid">
		...
		<div class="container-categoria">
			...
			<ol class="breadcrumb">
				...
				<li><a href="pecuaria-leite.html">Pecuária de Leite</a></li>
			</ol>
			<h2 class="text-center">Pecuária de Leite</h2>
			<div class="row">
				<div class="col-sm-12 col-md-12">
					<p class="text-center"><img src="_imagens/pecuaria-leite.jpg"class="img-radius" alt="Pecuária de corte"></p>
					<p class="text-justify"> A <strong>pecuária de leite</strong> é o nome dado à criação de gado com o objetivo de produção de leite, em sua maioria para a indústria de <abbr title="São o grupo de alimentos que inclui o leite, assim como os seus derivados processados (geralmente fermentados)">laticínios</abbr>.</p>
				</div>
			</div>
